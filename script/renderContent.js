export function RenderContent(){
  ...
  const homeDetails = {
    ...
    welcomeTxt: 'Welcome to my web Portfolio.',
    fbLink: '',
    tiktokLink: '',
    instagramLink: '',
    ytLink: ''
  ...
  const homeSection = document.querySelector('#home-section').innerHTML = homeHTML;
   ...
   const aboutDetails = {
    myPhoto: 'profile.jpg',
    aboutMeFirstPrgrph: `Hi! I'm Jaja, a student and programmer who loves sharing creative and inspiring work. I create content featuring my cute programming outputs, turning complex code into visually appealing and fun projects that resonate with my audience.`,
    aboutMeSecondPrgrph: `I also design code-based wallpapers and build unique portfolio websites that showcase my technical skills and artistic touch. Through my work, I aim to merge creativity and functionality, inspiring others to see the beauty in programming.`
   }
  ...
  const aboutSection = document.querySelector('#about-section').innerHTML = aboutHTML;
    ...
    const skills = [
      ...
      { iconName: "visual-studio.png", skillName: "VScode" },
       { iconName: "artist.jpg", skillName: "Artist" },
       { iconName: "Singer.jpg", skillName: "Singer" },
       { iconName: "Sporty.jpg", skillName: "Sporty" },
    ];
